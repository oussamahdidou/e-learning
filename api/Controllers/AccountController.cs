...
namespace api.Controllers
{
    ...
    public class AccountController : ControllerBase
    {
            ...
            try
            {
                ...
                if (userCreation.Succeeded)
                {
                    ...
                    if (userRole.Succeeded)
                    {
                        ...
                        var callback = QueryHelpers.AddQueryString("https://elearningmaroc.azurewebsites.net/auth/verify-email", param);
        ...
        public async Task<IActionResult> ForgotPassword([FromBody] ForgotPasswordDto forgotPasswordDto)
        {
            ...
            var callback = QueryHelpers.AddQueryString("https://elearningmaroc.azurewebsites.net/auth/reset-password", param);
